...
var en = map[string]string{
	...
	"footer_spelling":               "[m] Toggle MC  [Enter] Submit  [Esc] Back to Town  [q] Quit",
	...
	"settings_menu_lang_current":    "Language (current: %s)",
	"footer_history":                "[j/k] Navigate  [Enter/Esc] Back to Town",
	"footer_equipment":              "[j/k] Navigate  [Enter] Change  [Esc] Back to Town",
	"history_title":                 "Session History",
	"history_no_sessions":           "No sessions found.",

	"settings_api_placeholder": "Enter your Gemini API key",
	"footer_settings_confirm":  "[j/k] Navigate  [Enter] Select",
	"footer_settings_main":     "[j/k] Navigate  [Enter] Select  [Esc] Back to Town",

	"dungeon_placeholder":       "Your answer...",
	"dungeon_incorrect_answer":  "Incorrect. The answer was: %s",
	"dungeon_question_progress": "Question %d/%d: %s",
	"footer_dungeon":            "[j/k] Move  [Enter] Select/Answer  [Esc] Back to Town  [q/ctrl+c] Quit",
	"battle_placeholder":        "Your answer...",
	"battle_incorrect_answer":   "Incorrect. The answer was: %s",
	"battle_question_format":    "Question %d/%d: What is the meaning of '%s'?",
	"footer_battle":             "[j/k] Move  [Enter] Select/Answer  [Esc] Back to Town  [q/ctrl+c] Quit",
...
var ja = map[string]string{
	...
	"footer_equipment":            "[j/k] 移動  [Enter] 変更  [Esc] Townへ戻る",
	"history_title":               "セッション履歴",
	"history_no_sessions":         "セッションは見つかりませんでした。",
	"equipment_title":             "装備",
	"equipment_prompt":            "スロットを選択してEnterで装備を変更します。",
	...
	"footer_spelling":             "[m] MC切り替え  [Enter] 送信  [Esc] Townへ戻る  [q] 終了",
